#!/bin/bash
#SBATCH --job-name=morph_step3_2_4
...
#SBATCH --output=/public/home/hpc242111131/G-TAF/MORPH/logs/step3_2_4_%j.out
#SBATCH --error=/public/home/hpc242111131/G-TAF/MORPH/logs/step3_2_4_%j.err
...
python scripts/step3_2_4_b1_inference.py \
    --all \
    2>&1 | tee /public/home/hpc242111131/G-TAF/MORPH/logs/step3_2_4_$(date +%Y%m%d_%H%M%S).log
